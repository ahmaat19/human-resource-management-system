  ...
  return (
    <>
          ...
          <div className='modal-content modal-background'>
            <div className='modal-header'>
              <h5 className='modal-title' id='discountModalLabel'>
                {edit
                  ? 'Edit Employee Discount Form Request'
                  : 'Employee Discount Form Request'}
              </h5>
              <button
                type='button'
                className='btn-close'
                                ...
                                <div className='col-12 '>
                                  ...
                                  <div className='form-group'>
                                    ...
                                    <div id='wives' className='form-text'>
                                      Please use comma separated wives name if
                                      you have more than one wife (eg.
                                ...
                                <div className='col-12 '>
                                  ...
                                  <div className='form-group'>
                                    ...
                                    <div id='children' className='form-text'>
                                      Please use comma separated children's name
                                      if you have more than one child (eg.
      ...
      <div className='d-flex justify-content-between'>
        ...
        >
          {' '}
          <i className='fas fa-plus'></i> REGISTER NEW Discount
        </button>
      </div>
